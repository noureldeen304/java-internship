...
public class Dictionary {
    ...
    public void printWordsStartWith(Character character) {
        if (!dictMap.keySet().contains(Character.toUpperCase(character))) {
            throw new LetterNotFoundException(character);
        }
        System.out.println(dictMap.get(Character.toUpperCase(character)));
    }
